...
//        reader = new PetriNetIOImpl(false, true); // equivalent to null constructor  
    ...
    public void messagePrintedAndThrowsForFirstNonUnexpectedElementError() throws PetriNetComponentNotFoundException, JAXBException, FileNotFoundException {
    	...
    	try {
    		...
    		assertEquals("PetriNetValidationEventHandler error attempting to build Petri net from file "+path+": java.lang.RuntimeException: TestingThrowsPetriNetAdapter exception.", e.getMessage()); 
    	}
    ...
    @Test
    public void messagePrintedAndThrowsWhenUnexpectedElement() throws PetriNetComponentNotFoundException, JAXBException, FileNotFoundException {
    ...
    @Test
    public void generatesDetailedMessageForSpecificError() throws PetriNetComponentNotFoundException, JAXBException, FileNotFoundException {
    	...
    	assertEquals("PetriNetValidationEventHandler error attempting to build Petri net from file petriNet.xml: some exception", petriNetValidationEventHandler.getMessage()); 
    }
    @Test
    public void printsAllMessagesIfSpecificDetailedMessageNotPresent() throws PetriNetComponentNotFoundException, JAXBException, FileNotFoundException {
    	petriNetValidationEventHandler = new TestingPetriNetValidationEventHandler(false, true);
    	petriNetValidationEventHandler.setFilename("petriNet.xml"); 
