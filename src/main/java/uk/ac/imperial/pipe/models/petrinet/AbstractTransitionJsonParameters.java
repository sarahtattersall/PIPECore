...
public abstract class AbstractTransitionJsonParameters extends AbstractExternalTransition implements TransitionJsonParameters {
	...
	public void setExternalTransitionProvider(
		...
		if (!(externalTransitionProvider.getContext() instanceof JsonParameters)) {
			throw new IllegalArgumentException(ABSTRACT_TRANSITION_JSON_PARAMETERS+SET_CONTEXT_EXPECTED_JSON_PARAMETERS_FOUND + externalTransitionProvider.getContext().getClass().getName());
		}
